...
configure_adc:
    ;ADCON0 Bits
    BCF ADCON0, 2 ;Set the ADC channel to AN0 (((ADCON0) and 0FFh), 2, a:((ADCON0) and 0FFh), 5, a)
...
check:
    BTFSC ADCON0, 1 ;Check ((ADCON0) and 0FFh), 1, a/((ADCON0) and 0FFh), 1, a bit, skip if clear
    BRA check
