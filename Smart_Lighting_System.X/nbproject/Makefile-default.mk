...
FINAL_IMAGE=${DISTDIR}/Smart_Lighting_System.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=app.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Smart_Lighting_System.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F4620
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Smart_Lighting_System.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/app.o: app.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/app.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Smart_Lighting_System.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F4620 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Smart_Lighting_System.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
